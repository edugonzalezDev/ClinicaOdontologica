         ...
         for(odontologo of data){
           ...
           odontologoRow.id = tr_id;
            ...
            let updateButton = '<button' +
                                      ' id=' + '\"' + 'btn_id_odontologo_' + odontologo.id + '\"' +
                                      ' type="button" onclick="editar('+odontologo.id+')" class="btn btn-warning btn-sm">' +
            ...
            odontologoRow.innerHTML = '<td>' + odontologo.id + '</td>' +
                    '<td id=nombre_odontologo_'+odontologo.id+'>' + odontologo.nombre.toUpperCase() + '</td>' +
                    '<td id=apellido_odontologo_'+odontologo.id+'>' + odontologo.apellido.toUpperCase() + '</td>' +
                    '<td id=matricula_odontologo_'+odontologo.id+'>' + odontologo.matricula + '</td>' +
